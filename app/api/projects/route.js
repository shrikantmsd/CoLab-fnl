...
function getStandardNodes(format = 'CTD', version = 'R1') {
  if (format === 'CTD' && version === 'R1') {
    return [
      ...
      { module: 'Module 1', section: '1.0', title: 'Letter of Application', required: true },
      ...
      { module: 'Module 3', section: '3.2.S.2.1', title: 'Manufacturer(s)', required: true },
      ...
      // 3.2.A — Appendices
      { module: 'Module 3', section: '3.2.A.1', title: 'Facilities and Equipment', required: false },
      { module: 'Module 3', section: '3.2.A.2', title: 'Adventitious Agents Safety Evaluation', required: false },
      { module: 'Module 3', section: '3.2.A.3', title: 'Novel Excipients', required: false },
      // 3.2.R — Regional Information (SAHPRA granularity)
      { module: 'Module 3', section: '3.2.R.1.1', title: 'Overview', required: true },
      { module: 'Module 3', section: '3.2.R.1.2', title: 'Reference Product/s (local and foreign)', required: true },
      { module: 'Module 3', section: '3.2.R.1.3', title: 'Certificates of Analysis', required: true },
      { module: 'Module 3', section: '3.2.R.1.4', title: 'Pharmaceutical Availability Studies', required: true },
      { module: 'Module 3', section: '3.2.R.2', title: 'Parent API Manufacturer with Various Sites', required: false },
      { module: 'Module 3', section: '3.2.R.3', title: 'Certificate(s) of Suitability (CEPs)', required: false },
      { module: 'Module 3', section: '3.2.R.4', title: 'Multiple API Manufacturers', required: false },
      { module: 'Module 3', section: '3.2.R.5', title: 'Medical Device', required: false },
      { module: 'Module 3', section: '3.2.R.6', title: 'Materials of Animal and/or Human Origin', required: false },
      { module: 'Module 3', section: '3.2.R.7', title: 'Batch Records of Samples', required: true },
      { module: 'Module 3', section: '3.2.R.8', title: 'Other (SCoRE)', required: true },
