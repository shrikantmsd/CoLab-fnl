...
export async function GET(request) {
  ...
  try {
    ...
    // Try with sequence filter first, fallback without if column doesn't exist
    let nodes = null;
    let queryError = null;
    ...
    if (!seqErr) {
      ...
      // sequence_number column likely doesn't exist — query without it
      console.warn('sequence_number filter failed, loading without:', seqErr.message);
