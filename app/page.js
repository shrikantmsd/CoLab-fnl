  ...
  if (status === 'app') return (
    <div style={{display:'flex',flexDirection:'column',height:'100vh',overflow:'hidden'}}>
      ...
      <div style={{background:'#1A3D6B',display:'flex',alignItems:'center',
        ...
        {/* Checklist toolbar links — only visible on Checklist tab */}
        {activeTab === 'checklist' && (
          <>
            ...
            {[
              ...
              <button key={btn.id}
                onClick={() => window.__raisaSetTab && window.__raisaSetTab(btn.id)}
                style={{
                  padding:'0 12px', height:'44px', border:'none', cursor:'pointer',
