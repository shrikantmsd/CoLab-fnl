  ...
  return (
    <div style={{ height:'100%', overflowY:'auto', background:T.bg, padding:'20px 24px',
      ...
      <div style={{ background:T.white, borderRadius:12,
        padding: hasData ? '24px 32px' : '48px 32px',
        textAlign:'center', border:`1px solid ${T.border}`, marginBottom:24 }}>
        <div style={{ fontSize: hasData ? 32 : 48, marginBottom: hasData ? 8 : 16 }}>🚀</div>
        <h2 style={{ margin:0, color:T.navy, fontSize: hasData ? 18 : 20, marginBottom:8 }}>Welcome to RAISA</h2>
        <p style={{ color:T.muted, fontSize:14, lineHeight:1.7, maxWidth:480, margin:'0 auto 16px' }}>
          {hasData
            ? 'Your regulatory affairs intelligence system. Quick access to your projects, dossiers, checklists, and AI document review.'
