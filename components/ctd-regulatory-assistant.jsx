        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <svg width="28" height="28" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="3" y="1" width="23" height="30" rx="2" fill="#ffffff"/>
              <path d="M20 1 L26 7 L20 7 Z" fill="#E0E0E0"/>
              <path d="M20 1 L26 7 H20 V1Z" fill="#BDBDBD"/>
              <rect x="1" y="20" width="28" height="13" rx="2" fill="#E53935"/>
              <text x="15" y="30" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="900" fontSize="7" fill="#ffffff" letterSpacing="0.3">RAISA</text>
              <line x1="7" y1="11" x2="18" y2="11" stroke="#BDBDBD" strokeWidth="1.2" strokeLinecap="round"/>
              <line x1="7" y1="14" x2="20" y2="14" stroke="#BDBDBD" strokeWidth="1.2" strokeLinecap="round"/>
              <line x1="7" y1="17" x2="16" y2="17" stroke="#BDBDBD" strokeWidth="1.2" strokeLinecap="round"/>
            </svg>
            <div style={{ fontWeight: 900, fontSize: 17, letterSpacing: "-0.01em", fontFamily: "'DM Mono', monospace" }}>
              <span style={{ color: "#ff6b6b" }}>Co</span><span style={{ color: "#FFFFFF" }}>LAB</span>
            </div>
          </div>
          {/* App context info — like docuBridge title */}
          <div style={{ width: 1, height: 24, background: "rgba(255,255,255,0.25)" }} />
          <div style={{ fontSize: 12, fontWeight: 700, color: "rgba(255,255,255,0.9)", fontFamily: "'Segoe UI', sans-serif" }}>
