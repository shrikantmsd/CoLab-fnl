          ...
          <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '300px 1fr 300px', overflow: 'hidden' }}>
            ...
            <div style={{ overflow: 'auto', borderRight: `1px solid ${T.border}`,
              ...
              {loading ? (
                ...
                // Build nested structure: Module → top sections → leaf nodes
                                ...
                                <div key={topSec}>
                                  ...
                                  <div
                                    ...
                                    <span style={{ fontSize: 11, fontWeight: 600, color: '#1A3D6B', flex: 1,
                                      ...
                                      {topSec} {SEC_LABELS[topSec] ? '— ' + SEC_LABELS[topSec] : ''}
                                    </span>
...
function DossierNodeRow({ node, latestDoc, isSelected, isLast, depth, seqBadge,
  LINE, isNewSeq, onSelect, onUpload, uploading, onOperationChange }) {
    ...
    <div
      ...
      <div style={{ flex: 1, minWidth: 0, display: 'flex', alignItems: 'center', gap: 4 }}>
        ...
        <span style={{
          ...
          {hasDoc ? latestDoc.filename : node.section + ' ' + node.title}
        </span>
      </div>
